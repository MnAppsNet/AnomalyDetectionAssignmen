...
if __name__ == '__main__':
    ...
    # scoring_data is dictionary with the file names and data.
    ...
    #print(scoring_data)
    # config name has somthing like mse.dis or mse.ft, and evaluation string has the parameters of range based recall-precission (args.recall_alpha, args.recall_omega, args.recall_delta, args.recall_gamma, args.precision_omega, args.precision_delta, args.precision_gamma
