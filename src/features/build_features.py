...
if __name__ == '__main__':
    ...
    # load datasets
    # datasets is a dictionary with kyes the names of files and values Dataframes as were stored
    ...
    # they exclude label column and store it to file. Then return dataframe with no labels for each period. 
    for k in datasets:
    ...
    # using alteration chanins to produce features such as : 'identity': apply_identity,
    #    'difference': add_differencing,
    #    'execavg': add_executors_avg,
    #    'nodeavg': add_nodes_avg
    # read alteration.py comments.
